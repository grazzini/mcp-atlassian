        ...
        if is_cloud:
            ...
            if oauth_config:
                ...
                error_msg = (
                    ...
                    "enable OAuth with ATLASSIAN_OAUTH_ENABLE=true, or set ATLASSIAN_PASS_THROUGH_ONLY=true."
                )
                raise ValueError(error_msg)
            ...
            if personal_token:
                ...
                error_msg = (
                    ...
                    "CONFLUENCE_USERNAME and CONFLUENCE_API_TOKEN, or enable OAuth, "
                    "or set ATLASSIAN_PASS_THROUGH_ONLY=true."
                )
                raise ValueError(error_msg)
