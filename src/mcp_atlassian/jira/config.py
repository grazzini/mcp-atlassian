...
class JiraConfig:
    ...
    def from_env(cls) -> "JiraConfig":
        ...
        if oauth_config:
            ...
            if is_cloud:
                error_msg = "Cloud authentication requires JIRA_USERNAME and JIRA_API_TOKEN, JIRA_PERSONAL_TOKEN, or OAuth configuration (set ATLASSIAN_OAUTH_ENABLE=true for user-provided tokens)"
            else:
                error_msg = "Server/Data Center authentication requires JIRA_PERSONAL_TOKEN, JIRA_USERNAME and JIRA_API_TOKEN, or OAuth configuration"
            raise ValueError(error_msg)
