...
class JiraConfig:
    ...
    def from_env(cls) -> "JiraConfig":
        ...
        if is_cloud:
            # Cloud: OAuth takes priority, then basic auth, then pass-through
            if oauth_config:
                auth_type = "oauth"
                ...
                error_msg = (
                    ...
                    "or ATLASSIAN_PASS_THROUGH_ONLY=true for header-based authentication. "
                    ...
                    "ATLASSIAN_OAUTH_ENABLE=true, or set ATLASSIAN_PASS_THROUGH_ONLY=true."
                )
                raise ValueError(error_msg)
            ...
            if personal_token:
                ...
                error_msg = (
                    ...
                    "or OAuth configuration, or ATLASSIAN_PASS_THROUGH_ONLY=true "
                    ...
                    "JIRA_API_TOKEN, or enable OAuth, or set ATLASSIAN_PASS_THROUGH_ONLY=true."
                )
                raise ValueError(error_msg)
